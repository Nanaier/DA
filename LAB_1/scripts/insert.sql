...
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(key_id,season_id,season,tier,division,subdivision,match_id,match_name,home_team_id,home_team_name,away_team_id,away_team_name,score,home_team_score,away_team_score,home_team_score_margin,away_team_score_margin,result,home_team_win,away_team_win,draw);
